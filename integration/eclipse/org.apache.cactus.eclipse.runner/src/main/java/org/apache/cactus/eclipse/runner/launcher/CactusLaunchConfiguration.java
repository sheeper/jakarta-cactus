 ...
 * extension point.
 * 
 * @version $Id: CactusLaunchConfiguration.java 238816 2004-02-29 16:36:46Z vmassol $
 */
    ...
    implements ITestRunListener
{
        ...
        new Thread(new Runnable()
        {
            public void run()
            {
                    ...
                    Display.getDefault().asyncExec(new Runnable()
                    {
                        public void run()
                        {
                            ...
                            "CactusLaunch.message.containerManager.error"),
                            	...
                            	CactusPlugin.log("ATTENTION."+ex.getMessage());
                ...
                catch (CoreException e)
                {
                	...
                	CactusPlugin.log("ATTENTION1."+ex.getMessage());
                    CactusPlugin.displayErrorMessage(
                            CactusMessages.getString(
                    "CactusLaunch.message.containerManager.error"),
                            ex.getMessage(),
    ...
    public void testRunEnded(long theElapsedTime)
    {
        ...
        catch (CoreException e)
        {
        	...
        	CactusPlugin.log("Exception tearing down:"+ex.getMessage());
        }
...
/*
	...
	protected VMRunnerConfiguration createVMRunner(ILaunchConfiguration configuration,
			TestSearchResult testTypes, int port, String runMode) throws CoreException {
		String[] classpath = LauncherUtils.constructClasspath();
		if (classpath == null) {
			abort("Startup failed", null, IStatus.OK);
		}
