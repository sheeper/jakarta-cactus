 ...
 *
 * @version $Id: MockHttpServer.java 238816 2004-02-29 16:36:46Z vmassol $
 */
public final class MockHttpServer implements Runnable
{
     ...
     */
    public static synchronized int findUnusedLocalPort(String theHost, int theLowest,
        int theHighest)
        throws IOException
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            {
            	System.out.println("generating"+port);
                return port;
            }
            finally
            {
